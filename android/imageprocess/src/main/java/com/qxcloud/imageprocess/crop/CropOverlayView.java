    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                if(mTouchMode<2){
                    mTouchMode = 0;
                    Logger.e("++++++++++++++MotionEvent.ACTION_UP+++++++++++++++++++++++");
            ...
            case MotionEvent.ACTION_MOVE:
                Logger.e("++++++++++++++MotionEvent.ACTION_MOVE+++++++++++++++++++++++");
                if(mTouchMode<2){
...
//                mTouchMode -= 1;
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (mFixAspectRatio) {
            ...
            if (AspectRatioUtil.calculateAspectRatio(bitmapRect) > mTargetAspectRatio) {
                ...
                final float cropWidth = Math
                        .max(Edge.MIN_CROP_LENGTH_PX_W, AspectRatioUtil
                ...
                // the screen
                if (cropWidth == Edge.MIN_CROP_LENGTH_PX_W)
        ...
        if(!Edge.FREE_CLIPPING){
            Edge.MIN_CROP_LENGTH_PX_W = (int) Edge.getWidth();
            Logger.e("+++cfh++++CropPhoto++++++++"+Edge.getWidth());
        }
    }
